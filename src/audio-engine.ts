...
export class AudioEngine {
  ...
  private wireOnEnded(source: AudioBufferSourceNode): void {
    source.onended = () => {
      // Only fire if this source is still the current one (not replaced by seek/swap)
